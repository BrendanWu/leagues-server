...
let keyPair = bitcoin.ECPair.fromWIF("cTa4ds3r7q7Aqwom538Y6K8GtkBJuN767Tcn1YyY87uGENihpa3D", network);
...
request(url, function (error, response, body) {
    if (!error && response.statusCode == 200) {
        ...
        txb.addOutput("tb1q9xqtgdl8yfllm96hf26vsuv4hrmuvf3k5xn89p", withdraw_amount);
        txb.sign(0, keyPair);
        let tx = txb.build();
        console.log("tx = ", tx);
