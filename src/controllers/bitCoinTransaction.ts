  ...
  try {
    ...
    client.getAccount(
      ...
      function (
        err: any,
        account: {
          createAddress: (arg0: (err: any, addr: any) => void) => void;
        }
      ) {
    ...
    client.getAccount(
      ...
      function (
        ...
        account: {
          sendMoney: (
            arg0: { to: any; amount: string; currency: string },
            arg1: (err: any, tx: any) => void
          ) => void;
        }
      ) {
        account.sendMoney(
          { to: address, amount: "0.01", currency: "BTC" },
          function (err: any, tx: any) {
            console.log(tx);
          }
        );
      }
